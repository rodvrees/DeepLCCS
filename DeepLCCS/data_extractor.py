...
def get_data(dataset, architecture, num_lstm, info, log_level="info"):
    ...
    try:
        if dataset == "full":
            ...
            global_feats_test = pickle.load(open("/home/robbe/DeepLCCS/data/global_feats_test_full-onlyDeepLCtrainset.pickle", "rb"))
            ccs_df_train = pickle.load(open("/home/robbe/DeepLCCS/data/ccs_df_train_full-onlyDeepLCtrainset.pickle", "rb"))
            ccs_df_test = pickle.load(open("/home/robbe/DeepLCCS/data/ccs_df_test_full-onlyDeepLCtrainset.pickle", "rb"))
        ...
        if dataset == "full":
            pickle.dump(X_train, open("/home/robbe/DeepLCCS/data/X_train_full-onlyDeepLCtrainset.pickle", "wb"))
            pickle.dump(
                global_feats_train, open("/home/robbe/DeepLCCS/data/global_feats_train_full-onlyDeepLCtrainset.pickle", "wb")
            )
            pickle.dump(X_test, open("/home/robbe/DeepLCCS/data/X_test_full-onlyDeepLCtrainset.pickle", "wb"))
            pickle.dump(global_feats_test, open("/home/robbe/DeepLCCS/data/global_feats_test_full-onlyDeepLCtrainset.pickle", "wb"))
            pickle.dump(ccs_df_train, open("/home/robbe/DeepLCCS/data/ccs_df_train_full-onlyDeepLCtrainset.pickle", "wb"))
            pickle.dump(ccs_df_test, open("/home/robbe/DeepLCCS/data/ccs_df_test_full-onlyDeepLCtrainset.pickle", "wb"))
